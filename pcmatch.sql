...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2026 a las 19:45:21
...
(1, 1, '', 100000, '2026-03-10 21:16:59');
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `correo`, `telefono`, `password`, `rol`, `created_at`, `estado`) VALUES
(1, 'Juan', 'Pérez', 'Juanperezoso@gmail.com', '+57 123 456 7891', '$2y$10$x/cuphUo3SFJF7fpUDGUq.yCcsjw/s.wWm/8CdrhsxvdnLUd3lWcK', 'cliente', '2026-02-28 19:25:52', 1),
(2, 'Admin', 'PCMATCH', 'admin@pcmatch.com', NULL, '$2y$10$Q9gxEykl6iq4tCysFfgeZ.7cWMFhmt9CMP.Xt.jCw5K3di3S/HIuG', 'admin', '2026-02-28 19:47:57', 1),
(3, 'Migui', 'Ramirez', 'miguelito3er@gmail.com', '+573015589531', '$2y$10$cmTK4YrSS.wELP81HFfXreYpNHtpZn3QYytqNaNkspTjXmzozuMEW', 'cliente', '2026-03-16 18:28:05', 1);
